...
import org.jetbrains.kotlin.idea.search.ideaExtensions.KotlinIndexPatternSearcher;
...
public class PluginStartupComponent implements ApplicationComponent {
    ...
    public void initComponent() {
        ...
        ServiceManager.getService(IndexPatternSearch.class).registerExecutor(new KotlinIndexPatternSearcher());
    }
